...
''';
  ...
  static String answerUserQuery({
    ...
    // 11. Query: Gifts & Surprises for Partner (ซื้อของขวัญอะไรให้แฟน / ของขวัญ / เซอร์ไพรส์)
    if (cleanQuery.contains('ของขวัญ') || cleanQuery.contains('เซอร์ไพรส์') || cleanQuery.contains('วันเกิดแฟน') || cleanQuery.contains('ซื้ออะไรให้แฟน') || cleanQuery.contains('ให้แฟน')) {
      return '🎁💖 **ไอเดียเลือกของขวัญให้ "น้องฝน" (อายุ 23 ปี / เกิด 15 มกราคม):**\n\n'
          '1. 💄 **สายความสวยความงาม & สกินแคร์:**\n'
          '   • ลิปสติกแบรนด์โปรด (เช่น Dior Lip Glow, Rom&nd, Kiko) หรือเซ็ตสกินแคร์บำรุงผิวที่ฝนใช้ประจำ\n'
          '2. 👜 **สายแฟชั่น & ของใช้น่ารัก:**\n'
          '   • กระเป๋าสะพายใบเล็กมินิมอล หรือเสื้อผ้าน่ารักๆ ใส่ไปเที่ยวคู่กัน\n'
          '3. 🐱 **ของขวัญเกี่ยวกับน้องแมว (กังฟู & โอเลี้ยง):**\n'
          '   • สั่งทำพวงกุญแจ / เคสโทรศัพท์รูปน้องกังฟู & โอเลี้ยง หรือปลอกคอคู่น่ารักๆ\n'
          '4. 💍 **เครื่องประดับมินิมอลมีความหมาย:**\n'
          '   • สร้อยข้อมือเงินแท้ หรือแหวนคู่มินิมอล ใส่ติดตัวได้ทุกวัน\n'
          '5. 🎂 **มื้อพิเศษ & เค้กแฮนด์เมด:**\n'
          '   • พาไปดินเนอร์ร้านโปรด หรือสั่งเค้กมินิมอลพร้อมการ์ดเขียนความในใจจากต๋อง\n\n'
          '💡 **ทริกการเงินฉบับต๋อง:** ตั้งงบไว้ประมาณ 500 - 1,500 บาท เพื่อให้ฝนประทับใจสุดๆ โดยไม่กระทบเป้าหมายปลดหนี้แม่และเงินดาวน์ BMW ครับ! 💕✨';
    }

    // 12. Query: Romantic Travel & Trips (เที่ยว / ทริป / วันหยุด / ไปไหนดี)
    if (cleanQuery.contains('เที่ยว') || cleanQuery.contains('ทริป') || cleanQuery.contains('วันหยุด') || cleanQuery.contains('ไปไหนดี')) {
      return '🏖️🚗 **ไอเดียทริปเที่ยวคู่รัก ต๋อง & ฝน (เซฟงบ & เติมความหวาน):**\n\n'
          '1. 🌊 **ทริปทะเลชุมพร (บ้านเกิด/พักผ่อน):**\n'
          '   • แวะหาดทรายรี ดูพระอาทิตย์ตก ชิมอาหารทะเลสดๆ และแวะดูที่ร้านบ้านดวด ละแม\n'
          '2. 🍃 **ทริปธรรมชาติใกล้กรุง (กาญจนบุรี / สวนผึ้ง):**\n'
          '   • นอนแพริมน้ำ รับลมเย็นๆ ถ่ายรูปสวยๆ ให้ฝน บรรยากาศโรแมนติกมาก\n'
          '3. ☕ **วันเดย์ทริป คาเฟ่แมว & สวนสาธารณะ:**\n'
          '   • ชวนกันไปนั่งเล่นคาเฟ่ ถ่ายรูปเล่น ปิคนิคช่วงเย็น ประหยัดงบสุดๆ\n\n'
          '💡 **ทริกการเงิน:** วางแผนงบค่าน้ำมันและที่พักล่วงหน้า ช่วยให้เที่ยวสนุกแบบสบายกระเป๋าครับ! ✨';
    }

    // 13. Query: Relationship Advice & Motivation (งอน / ง้อ / กำลังใจ / ทะเลาะ / เครียด)
    if (cleanQuery.contains('งอน') || cleanQuery.contains('ง้อ') || cleanQuery.contains('ทะเลาะ') || cleanQuery.contains('เครียด') || cleanQuery.contains('เหนื่อย') || cleanQuery.contains('กำลังใจ')) {
      return '💖✨ **เคล็ดลับพิชิตใจฝน & ให้กำลังใจชีวิตคู่:**\n\n'
          '1. 🧋 **อาหารและของหวานคือยาวิเศษ:** ซื้อชานมไข่มุก หรือของอร่อยที่ฝนชอบไปฝากพร้อมรอยยิ้ม\n'
          '2. 👂 **รับฟังด้วยความเข้าใจ:** รับฟังสิ่งที่ฝนรู้สึกโดยไม่ต้องรีบแก้ปัญหา แค่กอดและบอกว่า "เค้าอยู่ข้างๆ เสมอนะ"\n'
          '3. 🐱 **พาน้องแมวมาช่วย:** อุ้มน้องกังฟูหรือโอเลี้ยงไปอ้อนฝน ช่วยเปลี่ยนบรรยากาศให้อารมณ์ดีขึ้นทันที!\n'
          '4. 🌹 **คำขอโทษที่จริงใจ:** สุภาพ อ่อนโยน และพูดคุยกันด้วยเหตุผล\n\n'
          '✌️ *ต๋องกับฝนจับมือกันมาตั้งแต่วันแรก อุปสรรคอะไรก็ผ่านไปได้แน่นอนครับ สู้ๆ นะครับ!* 💕';
    }

    // 14. Query: Savings & Financial Management (ออมเงิน / บริหารเงิน / สูตร / เงินเดือน)
    if (cleanQuery.contains('ออม') || cleanQuery.contains('บริหารเงิน') || cleanQuery.contains('สูตร') || cleanQuery.contains('เงินเดือน') || cleanQuery.contains('จัดการเงิน')) {
      return '💰📊 **สูตรบริหารเงินคู่รักฉบับ ต๋อง & ฝน (50-30-20):**\n\n'
          '1. 🏠 **50% ค่าใช้จ่ายจำเป็น:** ค่าน้ำมันรถ ⛽, บิลค่าไฟ ⚡, อาหารหลัก 🍲, ทรายแมว/อาหารแมว 🐱\n'
          '2. 🎁 **30% ความสุขคู่รัก:** ขนม/ชานม 🧋, มื้อพิเศษ 🥩, ช้อปปิ้ง 🛒\n'
          '3. 🏆 **20% เงินออมเพื่อเป้าหมายใหญ่:**\n'
          '   • กองทุนปลดหนี้แม่ 50,000 ฿ (อันดับ 1)\n'
          '   • เงินดาวน์ BMW 260,000 ฿ (อันดับ 2)\n'
          '   • ทุนร้านค้าบ้านดวด & ครอบครัวในอนาคต\n\n'
          '💡 *บันทึกรายรับ-รายจ่ายใน Kapookluxx ทุกวัน จะช่วยให้เห็นเงินเก็บโตขึ้นทุกเดือนครับ!* 🚀';
    }
